package com.edu.cursomc.resources.exception;
...
public class ResourceExceptionHadler {
	...
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrityExceptionException e, HttpServletRequest request){
